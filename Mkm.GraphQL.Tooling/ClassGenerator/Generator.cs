...
using Mkm.GraphQL.Tooling.CodeGenerator.DefinitionHandlers;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp;
using Microsoft.CodeAnalysis.CSharp.Syntax;
using System.Collections.Generic;

namespace Mkm.GraphQL.Tooling.CodeGenerator
{
    public class Generator
    {
        ...
        private NamespaceDeclarationSyntax GenerateNamespace(string schemaName)
        {
            ...
            return @namespace.AddUsings(
                ...
                SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("Mkm.GraphQL.Client.Attributes"))
            );
        }
    }
}
