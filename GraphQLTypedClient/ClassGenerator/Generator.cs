...
using GraphQLTypedClient.ClassGenerator.DefinitionHandlers;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp;
using Microsoft.CodeAnalysis.CSharp.Syntax;
using System.Collections.Generic;

namespace GraphQLTypedClient.ClassGenerator
{
    public class Generator
    {
        ...
        private NamespaceDeclarationSyntax GenerateNamespace(string schemaName)
        {
            ...
            return @namespace.AddUsings(
                ...
                SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("GraphQLTypedClient.ClassGenerator.Attributes"))
            );
        }
    }
}
